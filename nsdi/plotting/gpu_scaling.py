...
def plot_gpu_scaling():
    ...
    ax_thru.plot(num_reps, agg_thrus, color=colors[0], marker="o", ms=vol, label="Agg 10Gbps")
    ax_thru.scatter(num_reps, agg_thrus, color=colors[0], marker="o", s=vol)
    ax_thru.plot(slow_net_num_reps, slow_net_agg_thrus, color=colors[2], marker="d", ms=vol, label="Agg 1Gbps")
    ax_thru.scatter(slow_net_num_reps, slow_net_agg_thrus, color=colors[2], marker="d", s=vol)
