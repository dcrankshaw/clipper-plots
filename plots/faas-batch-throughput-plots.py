...
plot('tf_latency', legend=False, ylim=50)
plot('pyspark_10rf_local', ylim=100)
plot('pyspark_100rf_local', ylim=100)
plot('pyspark_lr_local', ylim=30)
plot('pyspark_svm_local', ylim=30)
plot('sklearn_svm_local', legend=True, ylim=100)
